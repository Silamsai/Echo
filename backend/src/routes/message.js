...
import { getMessages, uploadFile, deleteMessage, sendMessage, votePoll } from '../controllers/messageController.js';
...
message.post('/:messageId/vote', verifyToken, votePoll);
